package com.anandbagmar.webanalyticsautomation.inputdata;
...
import com.anandbagmar.webanalyticsautomation.common.FileUtils;
...
public class TestData extends CONFIG implements Serializable {
    ...
    private static void loadFile(String absoluteFilePath) {
        if (isFileLoaded(absoluteFilePath)) {
            ...
            loadedSections.put(absoluteFilePath, FileUtils.deserializeSectionsFromFile(absoluteFilePath, configureXStream()));
        }
    }
