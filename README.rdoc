...
* If you are using the JsSniffer plugin:
    ...
    -
    -
    The method engine.verifyWebAnalyticsData takes in different parameters for {JSSniffer}[https://github.com/anandbagmar/WAAT/wiki/WAAT-using-JSSniffer] Vs {HttpSniffer}[https://github.com/anandbagmar/WAAT/wiki/WAAT-using-HttpSniffer].
    Look at the respective wiki pages for detail info on how to use the same.
