...
* Install Android build and platform tools $ANDROID_HOME/tools/android update sdk --no-ui --force
* Install Appium:
    * Using node.js:
        * brew install node
        * npm install -g appium  OR
    * Using Appium app: https://bitbucket.org/appium/appium.app/downloads/
